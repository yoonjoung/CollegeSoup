...
# import ################ø
path<-c(
    "https://www.uvm.edu/sites/default/files/UVM-Office-of-Institutional-Research-and-Assessment/CDS2223.pdf", 
    "https://www.uvm.edu/sites/default/files/UVM-Office-of-Institutional-Research-and-Assessment/CDS2122.pdf",
    "https://www.uvm.edu/sites/default/files/UVM-Office-of-Institutional-Research/cds/cds2021.pdf", 
    "https://www.uvm.edu/sites/default/files/UVM-Office-of-Institutional-Research/cds/CDS1920.pdf",
    "https://www.uvm.edu/sites/default/files/UVM-Office-of-Institutional-Research/cds/cds1819.pdf"
    )
...
listofdata<-list(pdf5, pdf4, pdf3, pdf2, pdf1)
...
dta$pct_submitsat<-replace(dta$pct_submitsat,
    ...
    temp<-pdf%>%filter(grepl("submitting act scores", tolower(report))==TRUE)
        strings <- temp$report[1]%>%str_split("(?<=\\s)(?=\\S)")%>%unlist
        strings
      
dta$pct_submitact<-str_trim(strings[length(strings)-1])
dta$pct_submitact<-replace(dta$pct_submitact,
                          grepl("C9 ", temp$report[1])==TRUE, 
                          str_trim(strings[length(strings)-5]))
