...
```{r import}
# import ################ø
datadirectory<-("~/Dropbox/0Kids/CDS/CDS_data/CDS_Tulane/")
dir(datadirectory)

pdfraw1<-pdf_text(paste0(datadirectory, "CDS 2022-2023 Final.pdf")) %>% 
    read_lines()%>% as.data.frame() 
pdfraw2<-pdf_text(paste0(datadirectory, "CDS 2021-2022 Final.pdf")) %>% 
    read_lines()%>% as.data.frame() 
pdfraw3<-pdf_text(paste0(datadirectory, "CDS 2020-2021 Final.pdf")) %>% 
    read_lines()%>% as.data.frame() 
pdfraw4<-pdf_text(paste0(datadirectory, "CDS 2019-2020.pdf")) %>% 
    read_lines()%>% as.data.frame()
pdfraw5<-pdf_text(paste0(datadirectory, "CDS 2018-2019.pdf")) %>% 
    read_lines()%>% as.data.frame() 
pdfraw6<-pdf_text(paste0(datadirectory, "CDS 2017-2018.pdf")) %>% 
    read_lines()%>% as.data.frame()
```
