...
# import ################ø
path<-c(
    "https://www.stonybrook.edu/commcms/irpe/fact_book/common_data_set/_files/CDS_2022-2023.pdf", 
    "https://www.stonybrook.edu/commcms/irpe/fact_book/common_data_set/_files/CDS_2021-2022.pdf",
    "https://www.stonybrook.edu/commcms/irpe/fact_book/common_data_set/_files/CDS_2020-2021.pdf", 
    "https://www.stonybrook.edu/commcms/irpe/fact_book/common_data_set/_files/CDS_2019-2020.pdf", 
    "https://www.stonybrook.edu/commcms/irpe/fact_book/common_data_set/_files/CDS_2018-2019-Preliminary_v1.pdf", 
    "https://www.stonybrook.edu/commcms/irpe/fact_book/common_data_set/_files/CDS_2017-2018_Rev.pdf"
    )
...
dta$pct_submitsat<-str_trim(strings[length(strings)-1])
dta$pct_submitsat<-replace(dta$pct_submitsat,
...
dta$pct_top10pct<-str_trim(strings[length(strings)])    

    temp<-pdf%>%filter(grepl("Percent who had GPA of 4.0", report)==TRUE)
    strings <- temp$report[1]%>%str_split("(?<=\\s)(?=\\S)")%>%unlist
    strings
    
dta$pct_gpa4<-str_trim(strings[length(strings)])
dta<-dta%>%mutate(pct_gpa4=replace(pct_gpa4, pct_gpa4=="4.0", NA))
