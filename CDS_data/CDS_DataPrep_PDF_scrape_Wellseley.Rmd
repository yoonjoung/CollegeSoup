...
# import ################ø
path<-c(
    "https://www.wellesley.edu/sites/default/files/assets/departments/instresearch/files/cds_2022-2023-final-v4.pdf", 
    "https://www.wellesley.edu/sites/default/files/assets/departments/instresearch/files/cds_2021-2022_corrected_4192022_1.pdf",
    "https://www.wellesley.edu/sites/default/files/assets/departments/instresearch/files/cds_2020-2021_0.pdf", 
    "https://www.wellesley.edu/sites/default/files/assets/departments/instresearch/files/cds_2019-2020_updated_may_2020.pdf", 
    "https://www.wellesley.edu/sites/default/files/assets/departments/instresearch/files/cds_2018-2019-completed_jsj_edits.pdf", 
    "https://www.wellesley.edu/sites/default/files/assets/departments/instresearch/files/cds_2017-2018_201802.pdf"
    )
...
pdf<-as.data.frame(listofdata[[i]])
    ...
    temp2<-pdf%>%filter(grepl("Percent who are from out of state", laglag_report)==TRUE)
    print(temp2$report)
    temp2$report <- gsub("[^0-9%.-]", "", temp2$report)
    temp2$report <- gsub("%", " ", temp2$report, fixed=TRUE)
    strings2 <- temp2$report%>%str_split("(?<=\\s)(?=\\S)")%>%unlist
    print(strings2)    
