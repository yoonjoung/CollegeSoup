...
datadirectory<-("~/Dropbox/0Kids/CDS/CDS_Data/CDS_UMBC/")
dir(datadirectory)
...
pdfraw2<-pdf_text(paste0(datadirectory, "CDS_2021-2022.pdf")) %>% 
    read_lines()%>% as.data.frame() 
pdfraw3<-pdf_text(paste0(datadirectory, "CDS_2020-2021.pdf")) %>% 
    read_lines()%>% as.data.frame() 
pdfraw4<-pdf_text(paste0(datadirectory, "CDS_2019-2020.pdf")) %>% 
    read_lines()%>% as.data.frame()
pdfraw5<-pdf_text(paste0(datadirectory, "CDS_2018-2019.pdf")) %>% 
    read_lines()%>% as.data.frame() 
pdfraw6<-pdf_text(paste0(datadirectory, "CDS_2017-2018.pdf")) %>% 
    read_lines()%>% as.data.frame()
