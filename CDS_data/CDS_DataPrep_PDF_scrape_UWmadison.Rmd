...
```{r import}
# import ################ø
datadirectory<-("~/Dropbox/0Kids/CDS/CDS_data/CDS_0_data_raw/CDS_UWMadison/")
dir(datadirectory)


pdfraw1<-pdf_text(paste0(datadirectory, "CDS_2022-2023.pdf")) %>% 
    read_lines()%>% as.data.frame() 
pdfraw2<-pdf_text(paste0(datadirectory, "CDS_2021-2022.pdf")) %>% 
    read_lines()%>% as.data.frame() 
pdfraw3<-pdf_text(paste0(datadirectory, "CDS_2020-21.pdf" )) %>% 
    read_lines()%>% as.data.frame() 
pdfraw4<-pdf_text(paste0(datadirectory, "CDS_2019-20.pdf")) %>% 
    read_lines()%>% as.data.frame()
pdfraw5<-pdf_text(paste0(datadirectory, "CDS_2018-19.pdf")) %>% 
    read_lines()%>% as.data.frame() 
pdfraw6<-pdf_text(paste0(datadirectory, "CDS_2017-18.pdf")) %>% 
    read_lines()%>% as.data.frame()
```
